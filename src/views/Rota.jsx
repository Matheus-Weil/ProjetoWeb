                        ...
                        <Form className="form" onSubmit={this.Cadastrar}>
                          ...
                          <InputGroup
                            ...
                            <Input
                              ...
                              onBlur={e =>
                                this.setState({ fullNameFocus: false })}
                                onChange={(e) => this.setState({Escolas:e.target.value})}
                              /> 
                          </InputGroup>
                          <InputGroup
                            className={classnames({
                          ...
                          >
                            ...
                            <Input
                              placeholder="Bairros onde passa"
                              type="text"
                              onFocus={e =>
                                this.setState({ fullNameFocus: true })
                              }
                              onBlur={e =>this.setState({ fullNameFocus: false })}
                              onChange={(e) => this.setState({Bairros:e.target.value})}
                            />
                          </InputGroup>
                          <InputGroup
                            className={classnames({
                          ...
                          >
                            ...
                            <Input
                              placeholder="Veículo para transporte"
                              type="text"
                              onFocus={e =>
                                this.setState({ fullNameFocus: true })
                              }
                          ...
                          >
                            ...
                            <Input
                              ...
                              onBlur={e =>this.setState({ fullNameFocus: false })}
                              onChange={(e) => this.setState({informacoesAd:e.target.value})}
                            />
                          </InputGroup>
